const BasicCalculator = {
  ...
  action(op){
    ...
    switch(op){
      case '=':
        ...
        expression+= '=' + value;
        this.activateAction(op);
        // Disable editing after displaying the answer
      ...
      case 'AC':
        ...
        // Enable editing after clearing the display
  ...
  deactivateActions() {
    document.querySelectorAll('button[data-action].basic-button--active').forEach(button => {
